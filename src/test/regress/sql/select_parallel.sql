...
EXPLAIN (COSTS OFF)
SELECT stringu1 FROM tenk1 WHERE ctid > '(0,1)' LIMIT 1;
SELECT stringu1 FROM tenk1 WHERE ctid > '(0,1)' LIMIT 1;

EXPLAIN (COSTS OFF)
SELECT stringu1 FROM tenk1 WHERE ctid < '(400,1)' LIMIT 1;
SELECT stringu1 FROM tenk1 WHERE ctid < '(400,1)' LIMIT 1;

EXPLAIN (COSTS OFF)
SELECT stringu1 FROM tenk1 WHERE ctid >= '(0,1)' AND ctid <= '(400,1)' LIMIT 1;
SELECT stringu1 FROM tenk1 WHERE ctid >= '(0,1)' AND ctid <= '(400,1)' LIMIT 1;
